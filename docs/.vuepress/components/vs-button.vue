    ...
    return {
      ...
      <vs-button type="primary">primary</vs-button>
       `
        ...
        .trim(),
      code2: `
       <vs-button disabled type="primary">disabled</vs-button>
       `
        .replace(/^\s*/gm, '')
        .trim(),
      code3: `
        <vs-button  icon="home"  type="primary">home</vs-button>
        <vs-button  icon="phone-fill" type="primary" icon-position="right">call</vs-button>
        <vs-button  icon="visible"  type="primary">show password</vs-button>
       `
        .replace(/^\s*/gm, '')
        .trim(),
      code4: `
      ...
      code5: `
        <vs-button-group>
          <vs-button icon="left" icon-position="left">prev</vs-button>
          <vs-button>middle</vs-button>
          <vs-button icon="right" icon-position="right">next</vs-button>
        </vs-button-group>
       `
        .replace(/^ {8}/gm, '')
        .trim(),
      currentCode: this.code1
    };
  },
  components: {
    'vs-button': btn,
